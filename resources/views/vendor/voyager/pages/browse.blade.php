...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            <div class="browser_bread">
                <div class="browse-class">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('read', $data)
                                                <a href="{{ route('voyager.pages.show', $data->{$data->getKeyName()}) }}" title="{{ __('voyager::generic.view') }}" class="btn btn-sm btn-warning pull-right">
